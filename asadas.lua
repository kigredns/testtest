--[[
Custom Kavo Ui By TwiRwal
The Ui Used the Kavo 
The Ui Used The Fonts
...
-- Funkcja do ustawienia pogrubionego fontu dla każdego tekstu
ApplyBoldFont = function(guiElement)
...
-- Rekurencyjnie dla wszystkich dzieci elementu
for _, child in pairs(guiElement:GetChildren()) do
CustomBoldTheme.ApplyBoldFont(child)
end
end
}


return CustomBoldTheme
local themeStyles = {
    DarkTheme = {
